...
The website contains no client-side JavaScript, cookies, tracking, embedded social content, external fonts, API endpoints, or server functions. Do not add analytics, forms, or visitor logging without updating the privacy assessment and privacy page.
